...
<nav class="navbar navbar-expand-lg brand-navbar shadow-sm">
    <div class="container">
        ...
        <span class="navbar-text ms-auto">Jefe de área: <strong><%= jefe.getNombres() %> <%= jefe.getApellidos() %></strong></span>
        ...
        <div class="col-12">
            <div class="card brand-card p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="brand-section-title mb-1">Permisos pendientes de aprobación</h2>
                        <p class="text-muted mb-0">Revisa y deriva las solicitudes de tu equipo.</p>
                    </div>
                    <span class="badge bg-light text-primary">Área asignada #<%= jefe.getAreaId() %></span>
                </div>
                    ...
                    <table class="table align-middle">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="../PermisoController" method="post" class="d-inline-block mb-2">
                                ...
                                <form action="../PermisoController" method="post" class="d-inline-block w-100">
                                    <input type="hidden" name="accion" value="denegarArea">
                                    <input type="hidden" name="permisoId" value="<%= permiso.getId() %>">
                                    <div class="mb-2">
                                        <textarea name="observaciones" class="form-control" placeholder="Motivo de la denegatoria" required></textarea>
                                    </div>
                                    <button type="submit" class="btn btn-outline-danger btn-sm w-100">Denegar solicitud</button>
                                </form>
                            </td>
                        </tr>
                        <%       }
                        ...
                        <tr>
                            <td colspan="4" class="text-center text-muted py-4">No hay permisos pendientes.</td>
                        </tr>
                        <% } %>
                        </tbody>
                    </table>
